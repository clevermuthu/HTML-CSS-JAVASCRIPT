...
questionAdd.innerHTML = `What is ${num1} Addition by ${num2}?`;
questionSub.innerHTML = `What is ${num1} Subtract by ${num2}?`;
questionMul.innerHTML = `What is ${num1} Multiply by ${num2}?`;
